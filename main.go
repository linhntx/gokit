...
import (
	...
	"github.com/linhntx/gokit/account"
)

// const dbsource = "postgresql://postgres:postgres@localhost:5432/gokit?sslmode=disable"
const dbsource = "root:linh1234@tcp(localhost:3306)/test3"
